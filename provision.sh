...
echo_parameters()
{
    echo "Parameters received from Vagrantfile: $VAGRANT_HOST_DIR $SQL_PASSWORD"  
}
...
container_run_sqlserver()
{
    ...
    docker run -d --restart unless-stopped -p 1433:1433 -v sqlvolume:/var/opt/mssql -e SA_PASSWORD=$SQL_PASSWORD -e ACCEPT_EULA=Y --name docker-mssql sqlserver-2017-nonroot &
    wait $!
